#
# Getters and Setters are NOT NEEDED in Python but Good to Use Them
# becuase No Private instance variables in Python
# You can also have multiple Classes in One FIle
#
...
class Album:
    ...
    def add_song(self, song, position=None):
        ...
        if song_found is None:
            ...
            print("song_found object " + str(song_found.__dict__))
            if position is None:
...
class Artist:
    ...
    def add_album(self, album):
        ...
        #print(self.albums.__dict__) - Does Not Work Because List Not Object
    ...
    def add_song(self, name, year, title):
        ...
        print("album_found object " + str(album_found.__dict__))
